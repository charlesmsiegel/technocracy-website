...
narratives — emotional urgency, unverifiable firsthand claims, and explanations that make the
world feel larger and stranger than it is" and "redirect their attention to accredited
sources." A 61% reduction in "narrative drift." A well-kept garden, "defined as much by what
is gently removed as by what is grown."

## What it actually is
The Union's routine for making a true-but-inconvenient story — a THV-9 sighting, an RDE, a
...
- **Own the channel:** where suppression fails, acquire the outlet (nwo-14, "The Lantern")
  and schedule follow-up "for never."

**Mechanics.**
- The mundane campaign is an **extended Manipulation + Media (or Subterfuge)** contest against
  the narrative's spread; The Feed grants a large equipment/network bonus.
- **Healthy Skepticism** to dispel a live supernatural Effect: roll **Enlightenment**, needs a
  Sleeper witness present; opposes the Effect's successes. Coincidental by definition.
- **Consequence of failure:** a narrative that survives de-amplification is a genuine Consensus
  breach — the "unusual events in a metropolitan area" of the stable-predictable-tomorrow press
  release are exactly a de-amplification job still in progress.

## Requisition notes
- **Not gear.** A standing NWO service other Conventions request (FERAL BLOOM's Progenitors buy
  it as "cover-story" upkeep, pg-03/pg-15). Feed/algorithmic access is HOAR-gated to NWO and
  Syndicate; outlet acquisition runs through shell media groups (nwo-14).
- Countered mage-side by anything that puts the story in front of enough Sleepers *faster* than
  the garden can be weeded.

## Story hooks
- The cell has real footage of a Union RDE. They have hours before it is a "hoax" buried under
  a hundred fakes — the clock is a de-amplification campaign spinning up in real time.
- "The Lantern" was bought to bury one story. Its old editor kept a copy off-network and wants
  it out.
