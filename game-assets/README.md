...
M20 (Mage: the Ascension 20th Anniversary) stat writeups for every Wonder, Procedure,
...
|---|---|---|---|---|
| [DermaTrue™ Synthetic Skin](wonders/dermatrue-synthetic-skin.md) | Wonder (bio-material) | Progenitors / Iteration X | 1 | Divisions: Iteration X, Progenitors; PR: prosthetics milestone |
| [Universal Nanoscale Interface (UNI)](wonders/uni-universal-nanoscale-interface.md) | Wonder (Device) | Iteration X | 2 | Divisions: Iteration X accomplishments |
| [EDG Virtuous 8 / Desire Engine](wonders/edg-virtuous-8-desire-engine.md) | Wonder (Device, consumer) | Syndicate (Eris Design Group) | 1 | PR: Virtuous 8 launch; Divisions: Syndicate |
| [BioMechanics Access Limb](wonders/biomechanics-prosthetic-limb.md) | Wonder (implant) | Iteration X | 1 | Divisions: Iteration X; PR: 2-millionth limb |
| [SPD Reality-Toxin Hardware](wonders/spd-reality-toxin-hardware.md) | Talisman (tainted) | Syndicate / defunct SPD | 6 | Board LEDGER (sy-06, sy-09) |
| [Social Conditioning Refresh](procedures/social-conditioning-refresh.md) | Procedure (rote) | New World Order | 4 | Boards: MIRRORGLASS (nwo-06/08), forms |
| [Processing](procedures/processing.md) | Procedure (rote) | Syndicate / NWO | 5 | Board LEDGER (sy-11) |
| [Canary-Trap Document Seeding](procedures/canary-trap-seeding.md) | Procedure (rote/tradecraft) | New World Order | 0 | Board MIRRORGLASS (nwo-04, nwo-12) |
| [Adjustment (Memory Revision)](procedures/adjustment-memory-revision.md) | Procedure (rote) | NWO / Progenitors | 2 | Boards: multiple ("Adjusted", "Attuned") |
| [Narrative De-Amplification](procedures/narrative-de-amplification.md) | Procedure (rote) | New World Order | 1 | Boards: FERAL BLOOM (pg-15), MIRRORGLASS; Divisions: NWO |
...
game-assets/
  ...
  wonders/*.md         Devices / Talismans (one per file)
  procedures/*.md      Procedures (rotes)
