...
role-on-site: >
  Fills the careers.ts posting "Perimeter Operations Officer" (orbital-perimeter-operations-officer)
  — watches designated sectors, catalogues everything that moves, escalates anything the system
  labels "pending." Twelve-hour console rotation with the posting's "unusually generous retention
  bonus, which we are legally advised to mention is unrelated to anything."
...
- **Signature gear** — Perimeter Services console suite (Sentinel constellation feed), Implant Radio, the excellent coffee the posting promised.
...
## Backgrounds
- Enhancement 2, Resources 3 (that retention bonus), Requisitions 2, Backup 1

## Merits & Flaws
- **Merit: Eidetic Memory** — Tomas can recall the exact position of every catalogued object across a twelve-hour shift.
- **Flaw: Curiosity** — The one trait the posting quietly hoped he wouldn't have. "The sky is almost always empty." Tomas has started keeping private notes on the times it isn't.

## Description & Demeanor
Steady, watchful, a little lonely; the ideal shift officer, who finds genuine peace in an empty sector and genuine dread in a "pending" flag that takes too long to clear. Tomas likes the work, respects the crew, and has learned not to ask what the "appropriate directorate" does with the objects he escalates.
