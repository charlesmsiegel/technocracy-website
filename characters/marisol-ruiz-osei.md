---
name: Field Director Marisol Ruiz-Osei
...
role-on-site: >
  Assignee, FERAL BLOOM card pg-09 ("Sample recovery sweep — Cascades grid N-7 through N-11").
  Runs the field teams recovering specimen line THV-9 ("Thornveldt"), operating under the public
  cover of the Northern Range Invasive Predator Response Unit.
sds-degree: 3 (Default / training level)
damian-scale: 4 (Clever)
---
...
## Merits & Flaws
- **Merit: Animal Magnetism (inverted)** — Predators pause fractionally before committing to her; it has saved her life twice and terrifies her more each time.
- **Flaw: Guilty Conscience** — She has read pg-05 and pg-07. She knows Damage Control has been "buying the escape for a decade," and it is eating her.

## Description & Demeanor
Weathered, competent, quiet in the specific way of people who spend months in the field with things that should not exist. She is genuinely protective of her teams — "the specimen is wanted intact and so are the teams" is her line — and treats the cover-unit biologists, most of whom "were" real biologists before this assignment, with the tenderness of someone managing a shared lie.

## What They Want
To capture MOTHER-4 alive and bring the Thornveldt line back under control before the founding-date arithmetic reaches anyone who would have to act on it.

## Secret
She has quietly confirmed the pg-05 rebase — the containment loss began in 2013, not 2021 — and she has started keeping her own duplicate ledger off the meteorology group's servers, because she no longer trusts Damage Control to be the ones who investigate Damage Control.
